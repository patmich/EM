namespace LLT
{
	public sealed partial class EMText : LLT.TSTreeStreamEntry, LLT.ITSFactoryInstance
	{
		...
		public const int FontIdIndex_Offset = 76;
		public const int ContentIndex_Offset = 78;
		public const int MaxCharCount_Offset = 80;
		public const int EMTextSizeOf = 84;
		...
		public ushort ContentIndex
		{
			get
			{
				return _tree.ReadUInt16(_position + 76);
			}
			set
			{
		...
		public ushort MaxCharCount
		{
			get
			{
				return _tree.ReadUInt16(_position + 78);
			}
			set
			{
				_tree.Write(_position + 78, value);
			}
		}
